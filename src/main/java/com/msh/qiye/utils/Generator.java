...
public class Generator {
    public static void main(String[] args) {
        FastAutoGenerator.create("jdbc:mysql://localhost:3306/crm?serverTimezone=Asia/Shanghai", "root", "200032")
                .globalConfig(builder -> {
                    builder.author("msh")// 设置作者
                ...
                .packageConfig(builder -> {//设置包名
                    builder.parent("com.msh.qiye") // 设置父包名
